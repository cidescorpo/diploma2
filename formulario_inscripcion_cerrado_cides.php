...
<div class="row"><div class="col-md-4"></div><div class="col-md-4"><h3 class="font-medium text-uppercase mb-0"><p>Formulario Inscripción Cerrado <?php if($interno == 1) {echo "Interno" } ?></p></h3>
     </div><div class="col-md-4"></div></div>
<div class="row">

	 
     <div class="col-12">
                        <div class="card" style="background-color:#edf19c">
						<div class="card-body">
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                                <div class="form-group">
													...
													<input type="hidden" name="interno" value="<?php echo $interno; ?>">
