...
$id_curso = $_POST['id_curso'];
 ...
 $query  = "INSERT INTO registro_usuario_2 (";
     $query .=" id_curso, nombre_r,apellidos_r,email_r,telefono_r,rut_r,cargo_r,empresa_r,razonsocial, rutempresa ,giro, telefonoempresa, direccionempresa, comunaempresa , usosence, nombreotic, valortotal, nombreenviara,cargoenviara,emailenviara, direccionenviara, telefonoenviara, ocenvia, hesenvia,npenvia,empresaoparticular, usaotic, fecha_ingreso,interno, cerrado ";
     $query .=") VALUES (";
     $query .=" '{$id_curso}', '{$nombre_r}', '{$apellidopaterno_r}', '{$email_r}', '{$telefono_r}', '{$rut_r}', '{$cargo_r}', '{$empresa_r}', '{$razonsocial}', '{$rutempresa}','{$giro}', '{$telefonoempresa}','{$direccionempresa}','{$comunaempresa}', {$usasence},'{$nombreotic}',{$valortotal}, '{$nombreenviara}', '{$cargoenviara}', '{$emailenviara}', '{$direccionenviara}', '{$telefonoenviara}', {$oc}, {$hes}, {$npedido}, '{$empresaoparticular}', {$usaotic},now(), $interno, 1 "; 
     $query .=")";
	 $db->query($query);
	 if($db->query($sql)){
	  ////////////////////////////////////////////////////////////////////////////////////////////////////
...
$asunto =  $nombre_r .', Confirmación de inscripción a Curso de CIDES CERRADO';   
$asunto_admin = 'Confirmación de inscripción a Curso de CIDES CERRADO(Cides lleno los datos): '.$nombre_curso;
...
$mail->Username = ''; // Nuestro usuario en Mandrill              
$mail->Password = ''; // Key generado por Mandrill 
